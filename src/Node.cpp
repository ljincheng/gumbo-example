...
std::string CNode::cleanText() {
     PrettyPrint pprint(mpNode);
    return pprint.prettyPrintNode();
}

std::string CNode::cleanText(const char * baseUrl){
    PrettyPrint pprint(mpNode);
    return pprint.prettyPrintNode(baseUrl);
}
